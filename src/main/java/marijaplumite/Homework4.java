...
public class Homework4 {
    public static void main(String[] args) {
        ...
        answer = catsAge*7; // Initialize variable answer with value that I got from catsAge value (4) multiply 7. So answer now holds 28.
        System.out.println("Cats age in human years = " + answer ); // Print out text «Cats age in human =» followed by what is now stored in variable answer (28)
