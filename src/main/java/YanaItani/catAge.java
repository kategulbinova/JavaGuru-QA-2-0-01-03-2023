...
public class catAge {
    public static void main(String[] args) {
        ...
        float Owner = 26; // Defined a variable: my age
        String myName = "yana";
        float answer= 7* OreoCat; // Defined a variable that multiplies 7 years (which represents 1 cat's year to the amount of years specified in the variable 'OreoCat')
